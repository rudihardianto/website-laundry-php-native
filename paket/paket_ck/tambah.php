                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col">
                                <h5 class="card-title fw-bold">Tambah Paket Cuci Komplit</h5>
                            </div>
                        ...
                        <!-- START: form tambah daftar paket cuci komplit -->
                        <div class="row justify-content-center">
                            <div class="col col-md-10">
                        ...
                        <!-- END: form tambah daftar paket cuci komplit -->
                    </div>
                </div>
            </div>
        </div>
